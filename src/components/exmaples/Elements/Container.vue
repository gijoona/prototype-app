<template>
  <sui-container>
    ...
    <div>
      <sui-header size="large">Container
    ...
    <div>
      <sui-header size="large">Text Container
        <sui-header-subheader>
          A button can be formatted to show defferent levels of emphasis
        </sui-header-subheader>
      </sui-header>
      <sui-container text>
        <sui-header size="huge">Header</sui-header>
        <p>
          Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo
          ligula eget dolor. Aenean massa <b>strong</b>. Cum sociis natoque penatibus
          et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis,
    ...
    <sui-header size="huge">Variations</sui-header>
    <div>
      <sui-header size="large">Text Alignment
        <sui-header-subheader>
    ...
    <div>
      <sui-header size="large">Fluid
        <sui-header-subheader>
          A fluid container has no maximum width
        </sui-header-subheader>
      </sui-header>
      <sui-container fluid>
        <sui-header size="huge">Dogs Roles with Humans</sui-header>
        <p>
